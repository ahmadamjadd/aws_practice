locals {
  ...
  build_project   = "${local.name_prefix}-build"
  eb_application  = "${local.name_prefix}-app"
  eb_environment  = "${local.name_prefix}-env"
  artifact_bucket = "${local.name_prefix}-${random_id.bucket_suffix.hex}"
}
...
resource "aws_elastic_beanstalk_application" "app" {
  name = local.eb_application
}

resource "aws_elastic_beanstalk_environment" "env" {
  name                   = local.eb_environment
